...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.resultManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.result-managements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_questions') ? 'is-invalid' : '' }}" type="text" name="total_questions" id="total_questions" value="{{ old('total_questions', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_attempted') ? 'is-invalid' : '' }}" type="text" name="total_attempted" id="total_attempted" value="{{ old('total_attempted', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_correct') ? 'is-invalid' : '' }}" type="text" name="total_correct" id="total_correct" value="{{ old('total_correct', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_wrong') ? 'is-invalid' : '' }}" type="text" name="total_wrong" id="total_wrong" value="{{ old('total_wrong', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('score') ? 'is-invalid' : '' }}" type="text" name="score" id="score" value="{{ old('score', '') }}">
                @if($errors->has('score'))
                    <div class="invalid-feedback">
                        {{ $errors->first('score') }}
                    </div>
